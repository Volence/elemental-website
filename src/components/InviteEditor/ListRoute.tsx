...
import { InviteListView } from '@/components/InviteEditor'

const InviteListRoute: React.FC<AdminViewServerProps> = ({ initPageResult, params, searchParams }) => {
...
export default InviteListRoute
