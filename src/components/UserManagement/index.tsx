              ...
              <div style={editorStyles.editableField}>
                {discordId ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', borderRadius: 6, backgroundColor: 'rgba(88,101,242,0.1)', border: '1px solid rgba(88,101,242,0.3)' }}>
                    ...
                    <span style={{ fontSize: 13, color: 'var(--theme-text, #fff)' }}>Discord connected</span>
                  </div>
                ) : (
                  <a
                    href={`/api/auth/discord?link=true&returnUrl=${encodeURIComponent(`/admin/edit-user?id=${userId}`)}`}
