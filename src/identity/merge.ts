...
export const COVERED_PEOPLE_FIELDS: Record<string, string> = {
  ...
  'matches.productionWorkflow.assignedObservers': 'matches_rels.people_id',
  'matches.productionWorkflow.assignedProducers': 'matches_rels.people_id',
  'matches.productionWorkflow.assignedDirectors': 'matches_rels.people_id',
