...
export function StaffMemberCard({
  ...
  return (
    <div className="flex items-center gap-3 p-4 rounded-xl border-2 border-border bg-gradient-to-br from-card to-card/50 hover:border-primary/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-200 group">
      <div
