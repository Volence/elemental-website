        ...
        {(() => {
          ...
          return roleOrder.map((role) => {
            ...
            const colorMap: Record<string, string> = {
              ...
              'Co-Owner': 'bg-gradient-to-r from-amber-500 to-orange-500',
            ...
            const avatarColorMap: Record<string, { from: string, to: string, text: string, ring: string }> = {
              ...
              'Co-Owner': { from: 'from-amber-500/20', to: 'to-orange-600/10', text: 'text-amber-500', ring: 'ring-amber-500/20' },
