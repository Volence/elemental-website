...
export function SubstituteCard({
  ...
  return (
    <div className="group flex items-center gap-4 p-4 rounded-xl border-2 border-border bg-gradient-to-br from-background to-background/50 shadow-md hover:border-orange-500/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-200">
      {/* Avatar placeholder */}
