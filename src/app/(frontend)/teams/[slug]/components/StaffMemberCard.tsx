...
export function StaffMemberCard({
  ...
  return (
    <div className="group flex items-center gap-4 p-4 rounded-xl border-2 border-border bg-gradient-to-br from-background to-background/50 shadow-md hover:border-primary/50 hover:shadow-lg transition-all duration-200">
      <div 
