...
export default async function PugRegisterPage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-md">
      ...
      <p className="text-gray-400 mb-6">
        Open tier is available to everyone. Sign in with Discord to create your account and get
      ...
      <div className="mt-6 pt-5 border-t border-gray-800 text-xs text-gray-500 space-y-1">
        <p>Already have an Elemental account?</p>
        <p>
          Sign in at{' '}
          <a href="/admin/login" className="text-blue-400 hover:underline">
            /admin/login
          </a>
          , go to your user page, and use the &ldquo;Connect Discord&rdquo; button there. That links
          Discord to your existing account without creating a duplicate.
        </p>
      </div>
    </main>
  )
