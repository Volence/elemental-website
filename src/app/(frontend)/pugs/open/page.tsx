...
async function getPageState() {
  ...
  if (!token) {
    return { currentUser: null, isRegistered: false, seasonId: season?.id ?? null, seasonName: season?.name ?? null }
  }
...
export default async function PugOpenPage() {
  const { currentUser, isRegistered, seasonId, seasonName } = await getPageState()
