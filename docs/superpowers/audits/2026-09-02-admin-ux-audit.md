...
**Date:** 2026-09-02
**Status (2026-09-03):** shipped to prod: P0, P1, P2, P3 (admin kit), P5 (PUG tabs in URL, Players table, Matches on Prisma, Leaderboard filters), P6, P7, P8, P11 slice 1 (PUG layout, metadata, sitemap, footer, first paint, team cache), P12 slice 1 (visibility-aware polling, lazy dashboard tabs, N+1 fixes, focus ring, 12px floor), and the Scouting & Recruitment retirement (data kept, collections hidden). Remaining: P11 page primitives and token migration of the PUG, calendar and invite pages; P12 depth sweep and legacy tab strips; P10 dashboard once telemetry has data; P4a/P4b after identity step 2; P9 belongs to the identity program. Part 5 maps the overlap with the identity consolidation program.
